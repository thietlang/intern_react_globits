...
public class PositionStaffDto extends BaseObjectDto {
    ...
    public PositionStaffDto(PositionStaff entity) {
        ...
        try {
            if (entity.getFromDate().isBefore(dtf.parseDateTime("01-01-1900")) || entity.getFromDate().isAfter(dtf.parseDateTime("01-01-2100"))) {
                this.fromDate = null;
            } else {
                this.fromDate = entity.getFromDate();
            }
            if (entity.getToDate().isBefore(dtf.parseDateTime("01-01-1900")) || entity.getToDate().isAfter(dtf.parseDateTime("01-01-2100"))) {
                this.toDate = null;
            } else {
            ...
            logger.error("Date exception: {}", e.getMessage());
        }
